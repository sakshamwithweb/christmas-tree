...
const Navbar = ({ setPresent }) => {
    return (
        <div className='fixed top-0 left-0 flex justify-between w-full h-[8vh] items-center z-10 px-8 pointer-events-none'>
            ...
            <button className='bg-black text-white py-2 px-4 rounded-md pointer-events-auto flex items-center gap-2'> <Play size={15} /> Present</button>
        </div>
    )
}
